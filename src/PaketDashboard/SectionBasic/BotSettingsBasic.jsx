...
const TABS = [
  { key: "basic", label: "botSettingsBasic.tabs.basic" },
  { key: "reply", label: "botSettingsBasic.tabs.reply" },
  { key: "persona", label: "botSettingsBasic.tabs.persona" },
  { key: "faq", label: "botSettingsBasic.tabs.faq" },
];
            ...
            <div className="inline-flex p-1 rounded-full bg-white shadow-sm">
              {TABS.map((tItem) => {
                ...
                return (
                  ...
                  >
                    <span className="relative z-10">{t(tItem.label)}</span>
                    {active && (
                      <motion.div
            ...
            >
              <div className="px-5 py-8 md:px-10 md:py-10 flex-1 flex flex-col">
                  ...
                  >
                      ...
                      <>
                        <div className="mb-8">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.basic.botName.label")}
                          </label>
                          <input
                            value={botName}
                          ...
                          <p className="mt-2 text-[13px] text-gray-500">
                            {t("botSettingsBasic.basic.botName.desc")}
                          </p>
                        </div>

                        <div className="mb-8">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.basic.desc.label")}
                          </label>
                          <textarea
                            value={desc}
                          ...
                          />
                          <p className="mt-2 text-[13px] text-gray-500">
                            {t("botSettingsBasic.basic.desc.desc")}
                          </p>
                        </div>

                        <div className="mb-8">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.basic.lang")}
                          </label>
                          <input
                            value={botLang}
                        ...
                        <div className="mb-10">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.basic.speed.label")}
                          </label>
                          <input
                            value={speed}
                          ...
                          />
                          <p className="mt-2 text-[13px] text-gray-500">
                            {t("botSettingsBasic.basic.speed.desc")}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between gap-6">
                          <div className="min-w-0">
                            <h3 className="text-[18px] font-semibold text-gray-900">
                              {t("botSettingsBasic.basic.emoji.title")}
                            </h3>
                            <p className="mt-1 text-[13px] text-gray-500">
                              {t("botSettingsBasic.basic.emoji.desc")}
                            </p>
                          </div>
                    ...
                    {tab === "reply" && (
                      <>
                        <div className="mb-10">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.reply.welcome")}
                          </label>
                          <textarea
                        ...
                        <div className="mb-10">
                          <p className="text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.reply.timing.title")}
                          </p>

                          <div className="mt-4 space-y-4">
                            <RadioOption
                              checked={welcomeTiming === "first"}
                              title={t("botSettingsBasic.reply.timing.first.title")}
                              description={t("botSettingsBasic.reply.timing.first.desc")}
                              onClick={() => setWelcomeTiming("first")}
                            />
                            <RadioOption
                              checked={welcomeTiming === "every"}
                              title={t("botSettingsBasic.reply.timing.every.title")}
                              description={t("botSettingsBasic.reply.timing.every.desc")}
                        ...
                        <div className="mb-10">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.reply.default")}
                          </label>
                          <textarea
                            value={defaultReply}
                        ...
                        <div className="mb-4">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.reply.closing")}
                          </label>
                          <textarea
                    ...
                    {tab === "persona" && (
                      <>
                        <div className="mb-10">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.persona.desc.label")}
                          </label>
                          <textarea
                          ...
                          />
                          <p className="mt-2 text-[13px] text-gray-500">
                            {t("botSettingsBasic.persona.desc.desc")}
                          </p>
                        </div>

                        <div className="mb-10">
                          <p className="text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.persona.tone.title")}
                          </p>

                          <div className="mt-4 space-y-4">
                            <RadioOption
                              checked={personaTone === "friendly"}
                              title={t("botSettingsBasic.persona.tone.friendly.title")}
                              description={t("botSettingsBasic.persona.tone.friendly.desc")}
                              onClick={() => setPersonaTone("friendly")}
                            />
                            <RadioOption
                              checked={personaTone === "formal"}
                              title={t("botSettingsBasic.persona.tone.formal.title")}
                              description={t("botSettingsBasic.persona.tone.formal.desc")}
                        ...
                        <div className="mb-10">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.persona.example.label")}
                          </label>
                          <textarea
                          ...
                          />
                          <p className="mt-2 text-[13px] text-gray-500">
                            {t("botSettingsBasic.persona.example.desc")}
                          </p>
                        </div>

                        <div className="mb-4">
                          <label className="block text-[18px] font-semibold text-gray-900">
                            {t("botSettingsBasic.persona.restrictions.label")}
                          </label>
                          <textarea
                          ...
                          />
                          <p className="mt-2 text-[13px] text-gray-500">
                            {t("botSettingsBasic.persona.restrictions.desc")}
                          </p>
                        </div>
                      </>
                    )}
                        ...
                        <div className="mb-10">
                          <div className="w-full rounded-[32px] md:rounded-[36px] bg-white shadow-[0_26px_60px_rgba(0,0,0,0.12)] border border-[#F3F3F3] px-6 md:px-10 py-7 md:py-9">
                            <h2 className="text-[18px] md:text-[20px] font-semibold text-gray-900">
                              {editingFaqId ? t("botSettingsBasic.faq.editTitle") : t("botSettingsBasic.faq.addTitle")}
                            </h2>

                            <div className="mt-6">
                              <label className="block text-[14px] md:text-[15px] font-semibold text-gray-900">
                                {t("botSettingsBasic.faq.question")}
                              </label>
                              <input
                                type="text"
                                value={faqQuestion}
                            ...
                            <div className="mt-8">
                              ...
                              >
                                {editingFaqId ? t("botSettingsBasic.faq.saveBtn") : t("botSettingsBasic.faq.addBtn")}
                              </button>
                              ...
                              {editingFaqId && (
                                ...
                                >
                                  {t("botSettingsBasic.faq.cancelBtn")}
                                </button>
                              )}
                            </div>
                          </div>
                        ...
                        <div className="mt-2">
                          <div className="flex items-center justify-between gap-4 mb-5">
                            <h3 className="text-[20px] md:text-[22px] font-semibold text-gray-900">
                              {t("botSettingsBasic.faq.listTitle")}
                            </h3>
                            ...
                            <div className="flex items-center gap-3">
                              <span className="inline-flex items-center justify-center px-5 h-9 rounded-full bg-green-100 text-green-700 text-[13px] font-semibold">
                                {t("botSettingsBasic.faq.active")} : {activeCount}
                              </span>
                              <span className="inline-flex items-center justify-center px-5 h-9 rounded-full bg-gray-100 text-gray-700 text-[13px] font-semibold">
                                {t("botSettingsBasic.faq.inactive")} : {inactiveCount}
                              </span>
                            </div>
                          </div>
                                ...
                                >
                                  <div className="flex items-start justify-between gap-4">
                                    <button
                                      ...
                                      title={t("botSettingsBasic.faq.toggleTitle")}
                                    >
                                      {item.active ? t("botSettingsBasic.faq.active") : t("botSettingsBasic.faq.inactive")}
                                    </button>
                                    ...
                                    <div className="flex items-center gap-3">
                                      <button
                                        ...
                                        aria-label={t("botSettingsBasic.faq.editLabel")}
                                      >
                                      ...
                                      <button
                                        ...
                                        aria-label={t("botSettingsBasic.faq.deleteLabel")}
                                      >
                ...
                <div className="mt-auto pt-10 flex flex-col md:flex-row items-stretch md:items-center gap-4">
                  ...
                  >
                    {t("botSettingsBasic.buttons.save")}
                  </button>
                  ...
                  >
                    ...
                    <span>{t("botSettingsBasic.buttons.reset")}</span>
                  </button>
                </div>
              </div>
            </motion.div>
