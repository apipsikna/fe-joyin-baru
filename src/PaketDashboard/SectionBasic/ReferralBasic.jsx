...
export default function ReferralBasic({ profile }) {
  ...
  // const { referralCode } = useReferralCode(profile); // ❌ NOT USED ANYMORE
          ...
          >
            ...
            <div className="mt-3 flex items-center gap-3">
              <input
                value={referralCode}
                readOnly
                placeholder={t("referralBasic.code.placeholder")}
              ...
              <button
                ...
                title={t("referralBasic.code.copy")}
              >
                <HiOutlineDocumentDuplicate className="w-5 h-5" />
                {copied ? t("referralBasic.code.copied") : t("referralBasic.code.copy")}
              </button>
            </div>
          </motion.div>
        </motion.div>
                  ...
                  <thead className="bg-[#5FCAAC] text-white">
                    <tr>
                      <th className="py-4 px-4 text-left font-bold w-[64px]">
                        {t("referralBasic.list.table.no")}
                      </th>
                      <th className="py-4 px-4 text-center font-bold">{t("referralBasic.list.table.name")}</th>
                      <th className="py-4 px-4 text-center font-bold">{t("referralBasic.list.table.email")}</th>
                      <th className="py-4 px-4 text-center font-bold">{t("referralBasic.list.table.time")}</th>
                      <th className="py-4 px-4 text-center font-bold w-[120px]">
                        {t("referralBasic.list.table.status")}
                      </th>
                    </tr>
                  </thead>
