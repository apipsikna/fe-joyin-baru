...
// ===== Placeholder sederhana untuk "Obrolan"
function ChatPlaceholder() {
  return (
    <div className="p-6">
      <h1 className="text-xl font-bold mb-2">Obrolan</h1>
      <p className="text-gray-600">Halaman obrolan akan hadir di sini.</p>
    </div>
  );
}
  ...
  return (
    <div className="flex font-poppins h-screen w-screen overflow-hidden">
      ...
      >
        ...
        {activeMenu === MENU.CHAT && <ChatPlaceholder />}
