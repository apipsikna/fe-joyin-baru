...
const CFG = {
  ...
  // header / judul
  // titleText: "Obrolan", // Removed, used in translation
  headerGap: 14,
        ...
        <div className="mx-auto w-full j-enter-card" style={{ maxWidth: CFG.cardMaxW }}>
          ...
          >
            <div className="text-center" style={{ maxWidth: CFG.contentMaxW }}>
              ...
              >
                {t("obrolan.emptyState.desc1")}
                <br className="hidden md:block" />
                {t("obrolan.emptyState.desc2")}
              </p>
