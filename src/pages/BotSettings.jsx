...
const CFG = {
  ...
  // header / judul
  // titleText: "Pengaturan Bot", // Removed, used in translation
  headerGap: 14,
        ...
        <div className="mx-auto w-full j-enter-card" style={{ maxWidth: CFG.cardMaxW }}>
          ...
          >
            <div className="text-center" style={{ maxWidth: CFG.contentMaxW }}>
              ...
              >
                {t("botSettings.emptyState.title")}
              </h2>
              ...
              >
                {t("botSettings.emptyState.desc1")}
                <br className="hidden md:block" />
                {t("botSettings.emptyState.desc2")}
              </p>
